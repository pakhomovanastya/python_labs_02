...
## Какие инварианты?
Инварианты — это правила целостности объекта, которые должны соблюдаться всегда.     
...
# demo.py
---
## Создание тестовых объектов и вывод информации об объектах
![](/images/lab01/созданиме%20экземпляров.png)          

## Сравнение объектов
Оператор == вызывает магический метод __eq__        

Сравнение происходит по фамилии, имени, возрасту и курсу   
![](/images/lab01/__eq__.png)               

## Обработка ошибок при создании
Попытка создать студента с числом вместо фамилии            

Валидация в validate_name() выбрасывает исключение          

Исключение перехватывается и выводится сообщение            
![](/images/lab01/raise%20фамия%20-%20число.png)            

## Обработка ошибок при изменении атрибута
Сначала успешно меняем фамилию через сеттер         

Затем пытаемся установить пустую строку         

Валидация в сеттере выбрасывает исключение   
![](/images/lab01/raise%20фамилия%20пустая.png)                 

## Демонстрация атрибутов класса
Атрибуты класса доступны как через сам класс, так и через экземпляр         

Значения одинаковы для всех объектов                
![](/images/lab01/созданиме%20экземпляров.png)              
