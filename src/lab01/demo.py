...
if student1 == student2: #вызывает __eq__
    print(f"-{student1} и {student2} один и тот же студент")
else:
    print(f"-{student1} и {student2} разные студенты")
...
print(f"-Исходное состояние: {student3}")
student3.not_active()  # Изменение состояния
print(f"-После вызова not_active(): {student3}")
try:
...
print(f"-Стипендия студента {student1.surname}: {student1.to_collect_money()} руб.")
